...
def db_init():
    ...
    con.executescript("""
        CREATE TABLE IF NOT EXISTS users (
            ...
            bg_blur          INTEGER DEFAULT 2,
            blur_radius      INTEGER DEFAULT 22,
            blur_brightness  REAL    DEFAULT 0.4,
    ...
    migrations = [
        ...
        "ALTER TABLE users ADD COLUMN blur_brightness REAL DEFAULT 0.4",
...
CYCLES = {
    ...
    "blur_brightness": [0.25,0.35,0.45,0.55,0.65],
...
LABELS = {
    ...
    "blur_brightness": {0.25:"BG Dark: 25%",0.35:"BG Dark: 35%",0.45:"BG Dark: 45%",
                        0.55:"BG Dark: 55%",0.65:"BG Dark: 65%"},
...
PRESETS = {
    "cinematic": ("cinematic","cinematic",2,0.06,22,0.4),
    "action":    ("dramatic","vivid",2,0.09,26,0.35),
    "noir":      ("noir","muted",2,0.03,32,0.25),
    "anime":     ("anime","vivid",2,0.06,20,0.45),
    "manga_bw":  ("manga","manga_ink",0,0.04,22,0.4),
    "epic":      ("dramatic","golden",2,0.09,20,0.3),
    "cold":      ("cinematic","cold",2,0.06,22,0.4),
    "golden":    ("cinematic","golden",2,0.06,18,0.45),
}
...
INFO_MSGS = {
    ...
    "bg":    ("🌫️ BG Modes:\n"
              ...
              "🌫️ Blur BG — full page + blurred background\n"
              "🌫️✨ Blur+Zoom — full page + blur + zoom\n"
              "RECOMMENDED: Blur+Zoom"),
}

# ═══════════════════════════════════════════════════════════
# HELP TEXT
# ═══════════════════════════════════════════════════════════
HELP_TEXT = """🎌 *MangaVoice Ultra v4.0 — Help*
...
🌫️✨ *Blur+Zoom* — full page + blur + gentle zoom *(BEST)*
...
async def on_callback(update:Update, ctx:ContextTypes.DEFAULT_TYPE):
    ...
    # ── Show panels ───────────────────────────────────────
        ...
        db_set(cid, lang="en", voice="calm", style="cinematic",
               ...
               bg_blur=2, blur_radius=22, blur_brightness=0.4,
               zoom_amount=0.06, parallax=1, action_clips=1)
        s = db_get(cid)
...
def main():
    ...
    print("🎌 MangaVoice Ultra v4.0 — Running!")
