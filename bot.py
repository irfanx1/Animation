...
PRESETS = {
    "cinematic": ("cinematic","cinematic",4,0.03,22,0.38),
    "action":    ("dramatic","vivid",4,0.06,26,0.33),
    "noir":      ("noir","muted",4,0.0,32,0.22),
    "anime":     ("anime","vivid",4,0.03,20,0.42),
    "manga_bw":  ("manga","manga_ink",0,0.04,22,0.4),
    "epic":      ("dramatic","golden",4,0.06,20,0.28),
    "cold":      ("cinematic","cold",4,0.03,22,0.38),
    "golden":    ("cinematic","golden",4,0.03,18,0.42),
}
...
async def on_callback(update:Update, ctx:ContextTypes.DEFAULT_TYPE):
    ...
    # ── Show panels ───────────────────────────────────────
        ...
        db_set(cid, lang="en", voice="calm", style="cinematic",
               ...
               bg_blur=4, blur_radius=22, blur_brightness=0.38,
               zoom_amount=0.03, parallax=1, action_clips=1)
        s = db_get(cid)
